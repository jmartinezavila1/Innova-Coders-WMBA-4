    ...
    public static class WMBA4Initializer
    {
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            ...
            try
            {
                ...
                // StaffDivisions 
                if (!context.StaffDivision.Any())
                {
                    var staffDivision = new List<StaffDivision>
                    {
                        new StaffDivision { DivisionID = 1,StaffID = 22},
                        new StaffDivision { DivisionID = 2,StaffID = 23},
                        new StaffDivision { DivisionID = 3,StaffID = 23},
                        new StaffDivision { DivisionID = 4,StaffID = 24},
                        new StaffDivision { DivisionID = 5,StaffID = 24},
                    };

                    context.StaffDivision.AddRange(staffDivision);
                    context.SaveChanges();
                }
